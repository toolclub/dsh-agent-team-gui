...
function auditClientClosure(source) {
  ...
  invariant(/\bapiVersion:\s*6\b/.test(source), 'client bundle does not contain the RPC API v6 request contract')
...
function auditHostClosure(source, manifest) {
  ...
  invariant(/\bapiVersion:\s*6\b/.test(source), 'host bundle does not expose RPC API v6')
