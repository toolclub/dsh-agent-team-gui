    ...
    await run(async () => {
      ...
      const document = {
        ...
        squad: {
          ...
          triggerMode: 'model-tool' as const, failurePolicy: 'continue' as const, maxConcurrency: 3,
